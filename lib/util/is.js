...
exports.isCmccMobile = isCmccMobile;
exports.isCutcMobile = isCutcMobile;
exports.isCtccMobile = isCtccMobile;
 ...
 * @param strInput
 */
function isCmccMobile(strInput) {
 ...
 * @param strInput
 */
function isCutcMobile(strInput) {
 ...
 * @param strInput
 */
function isCtccMobile(strInput) {
 ...
 * @param splitFlag		    分隔符
 */
function isExist(subS, s, splitFlag) {
